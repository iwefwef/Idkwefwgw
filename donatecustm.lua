...
boothTab:AddButton("Update", function()
	if #customBoothText:Get() > 300 then
...
if signPass then
	...
	signTab:AddButton("Save", function()
		if #signText:Get() > 300 then
			return signText:Set("300 Character Limit")
		end
		if settingsLock then
			return
		end
	...
	local signHelpLabel = signTab:AddLabel("$C = Current, $G = Goal, 300 Character Limit")
